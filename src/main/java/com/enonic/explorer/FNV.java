...
public class FNV {
  ...
  public BigInteger fnv1_32(String string) {
    return fnv1_32(string.getBytes());
  }
  ...
  public BigInteger fnv1_64(String string) {
    return fnv1_64(string.getBytes());
  }
  ...
  public BigInteger fnv1a_32(String string) {
    return fnv1a_32(string.getBytes());
  }
  ...
  public BigInteger fnv1a_64(String string) {
    return fnv1a_64(string.getBytes());
  }

  public String toHex(BigInteger integer) {
